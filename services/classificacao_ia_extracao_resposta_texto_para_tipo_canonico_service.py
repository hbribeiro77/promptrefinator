...
ALIASES_TRIAGEM_IA_PARA_CANONICO: dict[str, str] = {
    ...
    "ANALISAR": "ANALISAR PROCESSO",
    "ANALISAR_PROCESSO": "ANALISAR PROCESSO",
    "RENUNCIAR_PRAZO": "RENUNCIAR PRAZO",
    "ENCAMINHAR_INTIMACAO": "ENCAMINHAR INTIMAÇÃO PARA OUTRO DEFENSOR",
    "ENCAMINHAR INTIMACAO": "ENCAMINHAR INTIMAÇÃO PARA OUTRO DEFENSOR",
    "ENCAMINHAR_INTIMACAO_PARA_OUTRO_DEFENSOR": "ENCAMINHAR INTIMAÇÃO PARA OUTRO DEFENSOR",
    "AGENDAR_RETORNO": "AGENDAR RETORNO",
    "DEVOLVER_A_INSTITUCIONAL": "DEVOLVER À INSTITUCIONAL",
    "DEVOLVER A INSTITUCIONAL": "DEVOLVER À INSTITUCIONAL",
    "URGENCIA": "URGÊNCIA",
